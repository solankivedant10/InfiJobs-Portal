...
import MlPortalSidebar from './MlPortalSidebar';

const MLPortalLayout: React.FC = () => {
            ...
            >
                ...
                <header className="hidden md:block sticky top-0 z-30 bg-[#0a0d12]/95 backdrop-blur-lg border-b border-gray-800/50">
                    <div className="flex items-center justify-between px-6 py-3">
                        ...
                        {/* Green gradient bar (decorative) */}
                        <div className="hidden lg:block w-48 h-1.5 rounded-full bg-gradient-to-r from-emerald-500 to-cyan-500" />
